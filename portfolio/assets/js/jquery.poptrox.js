...
(function ($) {
    ...
    $.fn.poptrox = function (options) {
        ...
        var settings = $.extend({
            ...
            popupBackgroundColor: 'rgba(0,0,0,0)', // (Default Style) Popup background color (when usePopupStyling = true)
            popupTextColor: '#000000', // (Default Style) Popup text color (when usePopupStyling = true)
            popupLoaderTextSize: '2em', // (Default Style) Popup loader text size
            popupCloserBackgroundColor: 'rgba(0,0,0,0)', // (Default Style) Popup closer background color (when usePopupStyling = true)
        ...
        if (settings.usePopupDefaultStyling) {
            ...
            if ($nav.length == 2) {
                ...
                $nav_next
                    .css('right', '0')
                    .css('width', wn)
                    .html('<div style="position: absolute; height: 100px; width: 125px; top: 50%; right: -20%; margin-top: -50px; color: black;">&gt;</div>');

                $nav_previous
                    .css('left', '0')
                    .css('width', wp)
                    .html('<div style="position: absolute; height: 100px; width: 125px; top: 50%; left: -60%; margin-top: -50px;">&lt;</div>');
